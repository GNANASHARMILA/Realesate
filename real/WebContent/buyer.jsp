...
<body>
	...
	<div class="card-container">
		<div class="card">
			...
			<h3>
				<center>Select the site</center>
			</h3>
			<button onclick="window.location.href='searchProperty.html'">
				<h3>Click here</h3>
			</button>
		</div>
		<div class="card">
			<img
				...
				alt="Image 1">
			<h3>
				<center>Check availability</center>
			</h3>
			<button onclick="window.location.href='searchProperty.html'">
				<h3>Click here</h3>
			</button>
		...
		<div class="card">
			<img
				src="https://png.pngtree.com/png-vector/20190307/ourmid/pngtree-real-estate-logo-png-image_781922.jpg">
			<h3>
				<center>Booking & Payment</center>
			</h3>
			<button onclick="window.location.href='bookingSite.jsp'">
				<h3>Click here</h3>
			</button>
		</div>
		<!-- <div class="card">
			...
			<button onclick="window.location.href='payment.html'"><h3>Click here</h3>
			</button>
		</div> -->
	</div>
